                                    ...
                                    <div class="col-7 col-md-10">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-2 d-none d-md-block text-md-center">
                                                <p>
                                                    {{ item.unit_price | money | replace(',00','')}}
                                                </p>
                                            </div>
                                            <div class="col-md-2 d-none d-md-block text-md-center">
                                                <p>
                                            ...
                                            <div class="col-12 col-md-2 text-md-center">
                                                <p>
                                                    {{ item.subtotal | money | replace(',00','')}}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-12 col-md-auto">
                            {% if order.shipping or order.discount %}
                                <div class="row no-gutters justify-content-end justify-content-md-center h5 mt-2">
                                    ...
                                    <span class="col col-md-auto text-right">{{ order.subtotal | money | replace(',00','')}}</span>
                                </div>
                            {% endif %}
                                ...
                                <div class="row no-gutters justify-content-end justify-content-md-center mt-2">
                                    ...
                                    <span class="col col-md-auto text-right">
                                        {% if order.shipping == 0  %}
                                            {{ 'Gratis' | translate }}
                                        {% else %}
                                            {{ order.shipping | money | replace(',00','')}}
                                        {% endif %}
                                    </span>
                                </div>
                            {% else %}
                            ...
                            {% if order.discount %}
                                <div class="row no-gutters justify-content-end justify-content-md-center mt-2">
                                    ...
                                    <span class="col col-md-auto text-right">- {{ order.discount | money | replace(',00','')}}</span>
                                </div>
                            {% endif %}
                            <div class="row no-gutters justify-content-end justify-content-md-center h3 mt-2">
                                ...
                                <span class="col col-md-auto text-right">{{ order.total | money | replace(',00','')}}</span>
                            </div>
                            {% if order.pending %}
