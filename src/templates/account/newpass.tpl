            ...
            <div class="col-md-8">
                {% if link_expired %}
                    ...
                    {% if contact_links and is_account_activation %}
                        {% include "snipplets/footer/navigation/contact-links.tpl" with {phone_and_mail_only: true} %}
                    {% endif %}
                ...
                {% else %}
                    ...
                    {% embed "snipplets/components/forms/form.tpl" with{form_id: 'newpass-form', submit_text: (customer.password ? 'Cambiar contraseña' : 'Activar cuenta')  | translate } %}
                        {% block form_body %}
                            ...
                            {% embed "snipplets/components/forms/form-input.tpl" with{type_password: true, input_for: 'password_confirm', input_name: 'password_confirm', input_id: 'password_confirm', input_label_text: 'Confirmar Contraseña' | translate } %}
                            {% endembed %}
