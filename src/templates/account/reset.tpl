    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="col-md-8">
                ...
                {% embed "snipplets/components/forms/form.tpl" with{form_id: 'resetpass-form', submit_text: 'Enviar email' | translate } %}
                    {% block form_body %}

                        {# Email input #}

                        {% embed "snipplets/components/forms/form-input.tpl" with{type_email: true, input_for: 'email', input_value: email, input_name: 'email', input_id: 'email', input_label_text: 'Email' | translate } %}
