    ...
    <head>
        ...
        <style>
            ...
            {% else %}
                ...
                @import url('{{ [settings.font_headings, settings.font_rest] | google_fonts_url('300, 400, 500, 600, 700') | raw }}');
        ...
        {# <link rel="stylesheet" href="{{ 'css/style-async.css.tpl' | static_url }}"> #}
