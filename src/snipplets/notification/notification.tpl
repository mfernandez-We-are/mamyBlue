        ...
        <div class="container text-center text-md-left">
            <div class="row align-items-md-center">
                ...
                <div class="col-md-auto">
                    <a href="#" class="js-notification-close js-acknowledge-cookies btn btn-cookies btn-medium px-4 py-2 d-inline-block">{{ "Entendido" | translate }}</a>
                </div>
            </div>
        </div>
    </div>
...
{% if add_to_cart %}
    {% include "snipplets/notification/notification-cart.tpl" %}
{% endif %}