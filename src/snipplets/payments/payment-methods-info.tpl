        ...
        <div id="info-payment-method-{{ paymentMethod.id }}" class="box">
            ...
            <h4 class="font-weight-normal mb-0">
                ...
                {% if hasDiscount %}
                    ...
                    <span class="price-compare m-right-half">{{ product.price | money | replace(',00','')}}</span>
                    <strong class="js-installments-one-payment h3 weight-strong text-primary">{{ priceWithDiscount | money | replace(',00','')}}</strong>
                {% else %}
