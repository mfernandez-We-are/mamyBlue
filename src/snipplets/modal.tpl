	...
	{% if modal_form_action %}
		...
		{% if modal_footer and modal_fixed_footer %}
			<div class="modal-with-fixed-footer">
				...
				{% endif %}
				<div class="js-modal-close {% if modal_mobile_full_screen %}js-fullscreen-modal-close{% endif %} modal-header {{ modal_header_class }} align-items-center">
					<span class="modal-close">
						{% if custom_close %}
							{% block modal_close %}{% endblock %}
						{% else %}
				...
				<div class="modal-body"> {% block modal_body %}{% endblock %}
					</div>
					{% if modal_footer and modal_fixed_footer %}
					</div>
				{% endif %}
				{% if modal_footer %}
					<div class="modal-footer {% if not modal_fixed_footer %}d-md-block{% endif %} {{ modal_footer_class }}"> {% block modal_foot %}{% endblock %}
						</div>
