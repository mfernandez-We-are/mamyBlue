 {#/*============================================================================
    ...
    {# clone newsletter notification on reload #}
    const queryString = window.location.search;
    const urlParams = new URLSearchParams(queryString);
    const newsletterSuccess = urlParams.get('shc');
    if(Boolean(newsletterSuccess)) {
        let message = jQueryNuvem('.js-newsletter .alert').clone();
        jQueryNuvem('body').prepend(message.addClass('newsletter-notification'));
        setTimeout(() => {
            message.remove();
        },5000);
    }
